...
namespace SiahaVoyages.Migrations
{
    ...
    [Migration("20220915151927_alter_Transfer_add_pickupTime_as_NgbTime")]
    partial class alter_Transfer_add_pickupTime_as_NgbTime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SiahaVoyages.App.Client", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("SiahaVoyages.App.NgbTime", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SiahaVoyages.App.Transfer", b =>
                {
                    ...
                    b.Property<bool>("IsAirportTransfert")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SiahaVoyages.App.Transfer", b =>
                {
                    b.HasOne("SiahaVoyages.App.Client", "ClientCompany")
                        .WithMany()
                        .HasForeignKey("ClientCompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SiahaVoyages.App.Driver", "Driver")
                        .WithMany()
                        .HasForeignKey("DriverId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SiahaVoyages.App.NgbTime", "PickupTime")
                        .WithMany()
                        .HasForeignKey("PickupTimeId");
