...
public class SiahaVoyagesDbContext :
    AbpDbContext<SiahaVoyagesDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(SiahaVoyagesConsts.DbTablePrefix + "YourEntities", SiahaVoyagesConsts.DbSchema);
